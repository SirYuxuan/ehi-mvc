...
import com.yuxuan66.ehi.utils.lang.scanner.consts.CommonConsts;
import com.yuxuan66.ehi.utils.lang.scanner.consts.ProtocolTypes;
...
public enum ScannerUtil {
    ...
    public static List<Class> scan(String pkg) {
        List<java.lang.Class> classList = new LinkedList<>();
        try {
            //包名转化为路径名
    ...
    static class UrlScanCallable implements Callable<List<Class>> {
        ...
        public List<Class> call() {
            ...
            java.util.List<Class> classList = new LinkedList<>();
            try {
